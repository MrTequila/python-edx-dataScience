...
#
X = pd.read_csv("Datasets/dataset-har-PUC-Rio-ugulino.csv", header=0, sep=";", decimal=",")
...
model = RandomForestClassifier(n_estimators=30, max_depth = 10, random_state=0, oob_score=True)
