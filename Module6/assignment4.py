...
DTC = tree.DecisionTreeClassifier(max_depth=max_depth, random_state=2)
...
benchmark(DTC, X_train, X_test, y_train, y_test, 'DTC')
#drawPlots(DTC, X_train, X_test, y_train, y_test, 'DTC')
