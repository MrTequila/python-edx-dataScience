...
# called X:
#
X = pd.read_csv("Datasets/College.csv", header=0, index_col=0)
print(X)
...
X_train, X_test, y_train, y_test = train_test_split(slice1, slice2, test_size=0.3, random_state=7)
