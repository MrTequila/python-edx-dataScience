...
#
X_train_temp = X.loc[(X['Year']<1986)]
y_train = X_train_temp['WhiteMale']
print(y_train)
X_train=X_train_temp.drop(['WhiteMale',"WhiteFemale", "BlackMale", "BlackFemale"], axis=1)
...
#
y_train = X_train_temp['BlackFemale']
print(y_train)
X_train=X_train_temp.drop(['WhiteMale',"WhiteFemale", "BlackMale", "BlackFemale"], axis=1)
model.fit(X_train, y_train)
